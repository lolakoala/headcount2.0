...
describe('DistrictRepository iteration 1 - part 1', () =>  {
  ...
  test('findByName returns object with individual district information', () => {
  ...
  test('each district has object with year/data as key value pairs.', () => {
  ...
  test('district data is rounded to the nearest hundredth', () => {
    const result = {"2004": 0.302, "2005": 0.267, "2006": 0.354,
      "2007": 0.392, "2008": 0.385, "2009": 0.39, "2010": 0.436,
  ...
  test('district data is sanitized and defaults to 0', () => {
    ...
    const result = {"2004": 1, "2005": 0, "2006": 0.125,
